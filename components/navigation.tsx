...
export function Navigation() {
  ...
  return (
    <>
      {/* Top Bar with Phone */}
      <div className={`fixed top-0 left-0 right-0 z-50 bg-[#C0111F] py-2 transition-all duration-500 ease-in-out ${isScrolled ? "opacity-0 -translate-y-full" : "opacity-100 translate-y-0"}`}>
        <div className="container mx-auto px-6 flex items-center justify-center lg:justify-end gap-6">
          <span className="hidden sm:flex items-center gap-2 text-white/80 text-sm">
            ...
            comercial@cartonagemcirculus.com.br
          </span>
      ...
      <motion.nav
        ...
        className={`fixed left-0 right-0 z-50 transition-all duration-500 ease-in-out ${isScrolled
          ? "top-0 bg-white shadow-md py-1"
          : "top-10 bg-white/95 py-6"
          }`}
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2 group">
            <div className="relative">
              <Image src="/logo_2.png" alt="Circulus Logo" width={100} height={150} className={`object-cover transition-all duration-500 ease-in-out ${isScrolled ? "w-[110px] h-[70px]" : "w-[150px] h-[100px]"}`} />
            </div>
          </a>
          ...
          <div className="hidden lg:block">
            <Button
              asChild
              className="bg-[#D2D3D5] hover:bg-[#BFC1C4] text-[#0D0D0D] px-6 py-2 rounded-lg font-medium transition-all duration-300"
            >
          ...
          >
            ...
            >
              ...
              >
                <Button
                  asChild
                  className="bg-[#D2D3D5] hover:bg-[#BFC1C4] text-[#0D0D0D] px-8 py-3 rounded-lg font-medium text-lg mt-4"
                >
